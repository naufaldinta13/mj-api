...
func init() {
	orm.RegisterModel(new(WorkorderFulfillmentItem))
}

// WorkorderFulfillmentItem model for workorder_fulfillment_item table.
...
func (m *WorkorderFulfillmentItem) MarshalJSON() ([]byte, error) {
	type Alias WorkorderFulfillmentItem
...
// Save inserting or updating WorkorderFulfillmentItem struct into workorder_fulfillment_item table.
// It will updating if this struct has valid Id
// if not, will inserting a new row to workorder_fulfillment_item.
// The field parameter is an field that will be saved, it is
// usefull for partial updating data.
func (m *WorkorderFulfillmentItem) Save(fields ...string) (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
...
// Delete permanently deleting workorder_fulfillment_item data
// this also will truncated all data from all table
// that have relation with this workorder_fulfillment_item.
func (m *WorkorderFulfillmentItem) Delete() (err error) {
	o := orm.NewOrm()
	if m.ID > 0 {
		var i int64
...
// assigned.
func (m *WorkorderFulfillmentItem) Read(fields ...string) error {
	o := orm.NewOrm()
